  ...
  return (
    ...
    <div className="main-container w-[1058px] h-[923px] relative mx-auto mt-3">
      ...
      <div className="form-section w-[635px] h-[923px] bg-white absolute top-0 left-[423px] z-10">
        ...
        <button className="submit-btn w-[237px] h-[48px] rounded-[15px] border border-gray-400 bg-white text-black mt-[49px] mx-auto ml-[81px]">
          <span className="block mt-[11px] text-center text-gray-500">Submit</span>
        </button>
      </div>
